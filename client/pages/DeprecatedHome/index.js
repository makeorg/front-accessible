...
import { type DeprecatedHomeType } from 'Shared/types/views';
...
export const HomePage = () => {
  ...
  const [data, setData] = useState<DeprecatedHomeType>({
    popularProposals: [],
  ...
  useEffect(() => {
    async function fetchData() {
      const homeData = await ViewsService.getDeprecatedHome();
