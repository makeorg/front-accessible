    ...
    <StaticPageWrapperStyle>
      ...
      <StaticPrimaryOrderedListStyle>
        <StaticPrimaryOrderedListItemStyle>
          ...
          <StaticParagraphStyle>
            Elles sont notamment accessibles et imprimables à tout moment par un
            lien direct en bas de la page d’accueil du site.
          </StaticParagraphStyle>
          <StaticParagraphStyle>
        ...
        <StaticPrimaryOrderedListItemStyle>
          ...
          <StaticParagraphStyle>
            ...
            exploités par lasociété Make.org, Société par Actions Simplifiées au
            capital de 1000 euros, ayant son siège social au 4 rue René
            Villermé, 75011, PARIS, immatriculée au RCS de PARIS sous le numéro
            820 016 095 (ci-après« Make.org »).
          </StaticParagraphStyle>
        </StaticPrimaryOrderedListItemStyle>
        <StaticPrimaryOrderedListItemStyle>
          <StaticThirdLevelTitleStyle>
        ...
        <StaticPrimaryOrderedListItemStyle>
          ...
          <StaticParagraphStyle>
            ...
            des parties. Les CGUS sont communiquées à chaque Utilisateur qui en
            prend connaissance.
          </StaticParagraphStyle>
          <StaticParagraphStyle>
            {
        ...
        <StaticPrimaryOrderedListItemStyle>
          ...
          <StaticSecondaryOrderedListStyle>
            <StaticSecondaryOrderedListItemStyle className="section5">
              ...
              <StaticParagraphStyle>
                Le site est ouvert au public et tous les Utilisateurs peuvent le
                visiter et voter sur des Propositions.
              </StaticParagraphStyle>
            </StaticSecondaryOrderedListItemStyle>
            <StaticSecondaryOrderedListItemStyle className="section5">
              <StaticFourthLevelTitleStyle>
              ...
              <StaticParagraphStyle>
                Tous les Utilisateurs peuvent voter sur le site, mais seuls les
                Utilisateurs inscrits peuvent faire des Propositions citoyennes.
                À cette fin, ceux qui le souhaitent peuvent s’inscrire sur le
                site en remplissant le formulaire prévu à cet effet. Ils doivent
                alors fournir l’ensemble des informations marquées comme
              ...
              <StaticParagraphStyle>
                ...
                Personnel en contactant Make.org par courriel à l’adresse&nbsp;
            ...
            <StaticSecondaryOrderedListItemStyle className="section5">
              ...
              <StaticParagraphStyle>
                ...
                (ci-après : le « Compte »), donnant accès à un espace personnel
                (ci-après : l’« Espace Personnel ») qui permet de gérer
                l’utilisation des Services sous une forme et selon les moyens
                techniques que Make.org juge les plus appropriés et qui peuvent
              ...
              <StaticParagraphStyle>
                ...
                mot de passe. Ils doivent immédiatement contacter Make.org s’ils
                remarquaient que leur Compte a été utilisé à leur insu. Ils
                reconnaissent à Make.org le droit de prendre toutes mesures
        ...
        <StaticPrimaryOrderedListItemStyle>
          ...
          <StaticSecondaryOrderedListStyle>
            <StaticSecondaryOrderedListItemStyle className="section6">
              ...
              <StaticParagraphStyle>
                Les propositions citoyennes déposées sur Make.org ont toutes une
                égale chance d’être transformées en actions.
              </StaticParagraphStyle>
              <StaticParagraphStyle>
                C’est par son vote que l’utilisateur peut permettre à une
                proposition de devenir une Action citoyenne sur lequel Make.org
                s’engage.
              </StaticParagraphStyle>
              <StaticParagraphStyle>
                Make.org conçoit ensuite son rôle comme un intermédiaire entre
                des propositions citoyennes et des partenaires actions. (
                <RedLinkStyle href="#anchor_partners" to="#anchor_partners">
            ...
            <StaticSecondaryOrderedListItemStyle className="section6">
              ...
              <StaticParagraphStyle>
                ...
                Il faut » et contenir un nombre maximum de 140 caractères. La
                Proposition Citoyenne doit être lisible et rédigée en langue
                française, sous une forme permettant d’être comprise de tous,
                sans langage abrégé et sans abus des lettres majuscules.
              </StaticParagraphStyle>
              <StaticParagraphStyle>
            ...
            <StaticSecondaryOrderedListItemStyle className="section6">
              ...
              <StaticParagraphStyle>
                La publication de la Proposition Citoyenne de l’Utilisateur est
                soumise à modération dans les conditions définies aux présentes
                CGUS. La demande de publication d’une Proposition Citoyenne sera
                traitée le plus rapidement qu’il est possible aux équipes de
                Make.org, avec l’objectif de répondre en moins de 48 heures.
              </StaticParagraphStyle>
              <StaticParagraphStyle>
                Le service de modération de Make.org examine chaque Proposition
                Citoyenne reçue avant de la mettre en ligne. En conséquence,
                l’Utilisateur doit veiller à ne pas réitérer inutilement l’envoi
                d’une proposition de Proposition citoyenne et à ne pas soumettre
                une même proposition de Proposition citoyenne. Il ne devra pas
                non plus spammer les Services en proposant les mêmes Solutions
                avec des adresses électroniques différentes.
              </StaticParagraphStyle>
              <StaticParagraphStyle>
              ...
              <StaticParagraphStyle>
                En cas de rejet de la Proposition citoyenne de l’Utilisateur, un
                courrier électronique lui sera adressé par Make.org lui
                notifiant ledit rejet. L’Utilisateur pourra alors librement
                soumettre une nouvelle Proposition citoyenne.
              </StaticParagraphStyle>
              <StaticParagraphStyle>
                Une fois publiée sur le Service, elle pourra être mise en avant
                sur les Services, sans pour autant que Make.org garantisse ni sa
            ...
            <StaticSecondaryOrderedListItemStyle className="section6">
              ...
              <StaticParagraphStyle>
                ...
                il adressera sa demande par mail à Make.org à l’adresse suivante
                :&nbsp;
                <MailToRedLinkStyle href="mailto:contact@make.org">
                  contact@make.org.
                </MailToRedLinkStyle>
              ...
              <StaticParagraphStyle>
                La demande de suppression de l’Utilisateur sera traitée dans un
                délai raisonnable par Make.org.
              </StaticParagraphStyle>
            </StaticSecondaryOrderedListItemStyle>
            <StaticSecondaryOrderedListItemStyle className="section6">
              <StaticFourthLevelTitleStyle>
              ...
              <StaticParagraphStyle>
                Les Utilisateurs peuvent tous se prononcer par le biais de votes
                sur les propositions citoyennes présentes sur le Site, sans
                avoir à créer de compte, en cliquant sur les boutons « D’accord
                », « Pas d’accord » ou « Vote Blanc ».
              </StaticParagraphStyle>
            </StaticSecondaryOrderedListItemStyle>
            <StaticSecondaryOrderedListItemStyle className="section6">
              <StaticFourthLevelTitleStyle>
              ...
              <StaticParagraphStyle>
                ...
                Make.org pourra éditer ou coéditer des livres blancs à vocation
                non commerciale reprenant, partiellement ou intégralement, les
                Propositions citoyennes.
              </StaticParagraphStyle>
              <StaticParagraphStyle>
                <StaticStrongStyle>
                ...
                Les Propositions citoyennes, et les votes y afférents, pourront
                en outre être repris, commentés et analysés par Make.org et/ou
                par des journalistes partenaires afin de réaliser des contenus
                éditoriaux.
              </StaticParagraphStyle>
              <StaticParagraphStyle>
                <StaticStrongStyle>
                ...
                espaces publicitaires exploités par les partenaires de Make.org.
                Dans ce cas, l’utilisation d’une Proposition citoyenne sur
                lesdits espaces publicitaires donnera lieu à la publication de
                la Proposition de manière anonyme si elle a été publiée
                anonymement ou sous-titrée avec le prénom, l’âge et le
          ...
          <StaticSecondaryOrderedListStyle>
            <StaticSecondaryOrderedListItemStyle className="section8">
              ...
              <StaticParagraphStyle>
                ...
                utilisation des Services. La responsabilité de Make.org ne
            ...
            <StaticSecondaryOrderedListItemStyle className="section8">
              ...
              <StaticParagraphStyle>
                ...
                caractère publicitaire ou faisant la promotion de services à but
                lucratif. L’Utilisateur s’engage à ne pas publier de
              ...
              <StaticParagraphStyle>
                L’Utilisateur s’engage à ne pas publier des propositions faisant
                la promotion ou dénigrant des partis, des organisations ou des
            ...
            <StaticSecondaryOrderedListItemStyle className="section8">
              ...
              <StaticParagraphStyle>
                ...
                Make.org en vue de la bonne exécution des présentes.
              </StaticParagraphStyle>
              <StaticParagraphStyle>
          ...
          <StaticSecondaryOrderedListStyle>
            ...
            <StaticSecondaryOrderedListItemStyle className="section9">
              ...
              <StaticParagraphStyle>
                ...
                utilise déjà par ailleurs pour atteindre le même objectif et que
            ...
            <StaticSecondaryOrderedListItemStyle className="section9">
              ...
              <StaticParagraphStyle>
                ...
                réclamations, actions et revendications quelconques que Make.org
                pourrait subir du fait de la violation, par l’Utilisateur de
                l’une quelconque de ses obligations ou garanties aux termes des
        ...
        <StaticPrimaryOrderedListItemStyle>
          ...
          <StaticParagraphStyle>
            ...
            les systèmes de Make.org, (iii) tous détournements des ressources
            ...
            commerciaux ou moraux de Make.org ou des usagers de son site, et
        ...
        <StaticPrimaryOrderedListItemStyle>
          ...
          <StaticSecondaryOrderedListStyle>
            <StaticSecondaryOrderedListItemStyle className="section11">
              ...
              <StaticParagraphStyle>
                Make.org s’engage à procéder régulièrement à des contrôles afin
                de vérifier le fonctionnement et l’accessibilité du site. A ce
                titre, Make.org se réserve la faculté d’interrompre
                ...
                extérieures, la force majeure, ou encore qui seraient dues à des
                perturbations des réseaux de télécommunication.
              </StaticParagraphStyle>
              <StaticParagraphStyle>
                Make.org ne garantit pas aux Utilisateurs (i) que les Services,
                soumis à une recherche constante pour en améliorer notamment la
                performance et le progrès, seront totalement exempts d’erreurs,
                de vices ou défauts, (ii) que les Services, étant standard et
                nullement proposés à la seule intention d’un Utilisateur donné
                en fonction de ses propres contraintes personnelles, répondront
            ...
            <StaticSecondaryOrderedListItemStyle className="section11">
              ...
              <StaticParagraphStyle>
                Bien que les Services fassent l’objet d’une modération, Make.org
                ne peut être tenu pour responsable des Contenus, dont les
                auteurs sont des tiers, toute réclamation éventuelle devant être
            ...
            <StaticSecondaryOrderedListItemStyle className="section11">
              ...
              <StaticParagraphStyle>
                ...
                responsabilité en cas de perte éventuelle des informations
                accessibles dans l’Espace Personnel de l’Utilisateur, celui-ci
                devant en sauvegarder une copie et ne pouvant prétendre à aucun
          ...
          <StaticSecondaryOrderedListStyle>
            <StaticSecondaryOrderedListItemStyle className="section12">
              ...
              <StaticParagraphStyle>
                ...
                Make.org au sein du site sont protégés par tous droits de
              ...
              <StaticParagraphStyle>
                ...
                plus généralement toute exploitation non autorisée de tout ou
                partie du Service et des informations qui y sont contenues, sans
                autorisation expresse de Make.org, engagera la responsabilité de
                l’Utilisateur.
              </StaticParagraphStyle>
              <StaticParagraphStyle>
            ...
            <StaticSecondaryOrderedListItemStyle className="section12">
              ...
              <StaticParagraphStyle>
                ...
                d’exploitation non-exclusive, transférable et gratuite, pour la
                France et pour l’ensemble du monde, pour tout usage en ligne et
                pour tout mode de diffusion, pendant la durée des présentes CGUS
        ...
        <StaticPrimaryOrderedListItemStyle>
          ...
          <StaticParagraphStyle>
            ...
            loi ou règlement applicable, Make.org pourra résilier à son encontre
            les présentes Conditions Générales d’Utilisation de plein droit et
            sans préavis ni formalité préalable.
          </StaticParagraphStyle>
          <StaticParagraphStyle>
            ...
            courriel, à l’adresse qu’il a renseignée lors de son inscription. La
            résiliation interviendra sans préjudice des dommages et intérêts que
            pourrait réclamer Make.org en réparation des préjudices
            éventuellement subis du fait des manquements reprochés à
            l’Utilisateur. Make.org pourra refuser par la suite à l’Utilisateur
            la création d’un nouveau compte sur le Service.
          </StaticParagraphStyle>
          <StaticParagraphStyle>
        ...
        <StaticPrimaryOrderedListItemStyle>
          ...
          <StaticParagraphStyle>
            ...
            moment, en adressant une demande à cet effet à Make.org par courriel
            à&nbsp;
            <MailToRedLinkStyle href="mailto:contact@make.org">
              contact@make.org
            </MailToRedLinkStyle>
          ...
          <StaticParagraphStyle>
            ...
            suppression automatique du Compte de l’Utilisateur Inscrit ainsi que
            de ses Propositions.
          </StaticParagraphStyle>
        </StaticPrimaryOrderedListItemStyle>
        <StaticPrimaryOrderedListItemStyle>
        ...
        <StaticPrimaryOrderedListItemStyle>
          ...
          <StaticParagraphStyle>
            ...
            donné de l’une des stipulations des présentes ne pourra être ni
            interprété ni considéré comme une renonciation à ses droits en vertu
            des présentes, n’affectera en aucune manière la validité de tout ou
            partie des présentes et ne portera pas atteinte aux droits de la
            Partie concernée d’agir en conséquence.
          </StaticParagraphStyle>
          <StaticParagraphStyle>
