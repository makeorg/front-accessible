    ...
    <>
      ...
      <StaticPageWrapperStyle>
        <StaticSecondLevelTitleStyle>
          ...
          <StaticTitleExtra>- en date du 03/01/2019 -</StaticTitleExtra>
        </StaticSecondLevelTitleStyle>
        <StaticParagraphStyle>
          Le présent document complète les Conditions Générales de MAKE.ORG et
          représente les engagements de Make.org en ce qui concerne le respect
          de la réglementation en vigueur applicable au traitement de données à
          caractère personnel et, en particulier, le règlement (
        ...
        <StaticParagraphStyle>
          Dans ce cadre, Make.org sera responsable de traitement.
        </StaticParagraphStyle>
        <StaticPrimaryUnorderedListStyle>
          <StaticPrimaryUnorderedListItemStyle>
            <StaticThirdLevelTitleStyle>
            ...
            <StaticParagraphStyle>
              Make.org est particulièrement soucieux de la protection des
              données personnelles en général et de celle de ses utilisateurs en
              particulier. Il s’agit pour Make.org de l’une des valeurs
              fondamentales du numérique et d’une condition essentielle de la
              liberté de conscience. À cette fin, Make.org s’engage à limiter la
              quantité de données personnelles recueillies à ce qui est
              seulement nécessaire pour le fonctionnement de son site et de ses
              services.
            </StaticParagraphStyle>
            <StaticParagraphStyle>
              Make.org a déposé une déclaration à la CNIL sous le numéro 2005312
              et a choisi de nommer un DPO afin de garantir le meilleur niveau
              de protection qu’il est possible.
            </StaticParagraphStyle>
            <StaticParagraphStyle>
              Make.org ne pourra procéder à un traitement de données
              personnelles que dans le strict exercice de sa mission.
            </StaticParagraphStyle>
            <StaticParagraphStyle>
          ...
          <StaticPrimaryUnorderedListItemStyle>
            ...
            <StaticParagraphStyle>
              Les données à caractère personnel traitées en exécution de la
              mission ne pourront faire l’objet d’aucune divulgation à des tiers
              en dehors des cas prévus ci-dessus, ou par une disposition légale
              ou réglementaire.
            </StaticParagraphStyle>
          </StaticPrimaryUnorderedListItemStyle>
          <StaticPrimaryUnorderedListItemStyle>
          ...
          <StaticPrimaryUnorderedListItemStyle>
            ...
            <StaticParagraphStyle>
              Make.org applique l’ensemble des droits des utilisateurs tels que
              : droit d’accès, de rectification, d’effacement et d’opposition,
              droit à la limitation du traitement, droit à la portabilité des
              données, droit de ne pas faire l’objet d’une décision individuelle
              automatisée (y compris le profilage).
            </StaticParagraphStyle>
            <StaticParagraphStyle>
              Cet exercice peut être fait par tout moyen, et notamment par
          ...
          <StaticPrimaryUnorderedListItemStyle>
            ...
            <StaticParagraphStyle>
              ...
              respecter l’intégrité et la confidentialité des données à
              caractère personnel.
            </StaticParagraphStyle>
            <StaticParagraphStyle>
          ...
          <StaticPrimaryUnorderedListItemStyle>
            ...
            <StaticParagraphStyle>
              ...
              &nbsp;FWPA Avocats, 18 rue des Pyramides, 75001, Paris,
              représentée par Maître Jean-Baptiste Soufron.
            </StaticParagraphStyle>
            <StaticParagraphStyle>
          ...
          <StaticPrimaryUnorderedListItemStyle>
            ...
            <StaticParagraphStyle>
              Make.org déclare tenir par écrit un registre de toutes les
              catégories d’activités de traitement effectuées dans le cadre de
