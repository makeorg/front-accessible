...
describe('OrganisationService', () => {
  ...
  describe('getOrganisations', () => {
    it('must call ApiService.callApi', async () => {
      ...
      expect(ApiService.callApi).toHaveBeenNthCalledWith(1, ORGANISATIONS_PATH, {
        method: 'GET',
        params: {
          slug: 'foo',
        }
  ...
  describe('getOrganisationProposals', () => {
    it('must call ApiService.callApi', async () => {
      ...
      expect(ApiService.callApi).toHaveBeenNthCalledWith(1, ORGANISATION_PROPOSALS_PATH.replace(':organisationId', 'foo'), {
        method: 'GET',
      });
    });
  });
  ...
  describe('getOrganisationsVotes', () => {
    it('must call ApiService.callApi', async () => {
      ...
      expect(ApiService.callApi).toHaveBeenNthCalledWith(1, ORGANISATION_VOTES_PATH.replace(':organisationId', 'foo'), {
        method: 'GET',
      });
    });
  });
