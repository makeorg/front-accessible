...
describe('MainFooterComponent', () => {
  it('Check a11y rules', () => {
    const props = {
      questionConfiguration: { wording: { question: 'foo' } , theme: { footerFontColor: 'bar' } }
    }
    ...
    expect(wrapper.find(MainFooter.Nav).text()).to.equal(props.questionConfiguration.wording.question);
