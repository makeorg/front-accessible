...
export const forgotPasswordRequest = email => ({ type: actionTypes.FORGOT_PASSWORD_REQUEST, email });
export const forgotPasswordSuccess = () => ({ type: actionTypes.FORGOT_PASSWORD_SUCCESS });
export const forgotPasswordFailure = errors => ({ type: actionTypes.FORGOT_PASSWORD_FAILURE, errors });
